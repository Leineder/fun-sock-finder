...
export const config = {
  ...
  // (e.g. /sl/.../3991). Set TARGET_STORE_ID in GitHub repo secrets/variables.
  storeId: process.env.TARGET_STORE_ID || "3991",
  storeName: process.env.TARGET_STORE_NAME || "your Target",

  // What we search for. "fun socks" casts a wide novelty net.
  keyword: process.env.TARGET_KEYWORD || "fun socks",

  // How many products to pull per run (paginated 24 at a time under the hood).
  maxProducts: Number(process.env.TARGET_MAX_PRODUCTS || 240),
